...
function SkpProofComponent() {
    ...
    const onGenerateProof = async () => {
        ...
        try {
            ...
            //     { id: "0x10", x: "0x01", y: "0x07", health: 200, type: WALL }, { id: "0x11", x: "0x00", y: "0x07", health: 200, type: WALL },
            //     { id: "0x12", x: "0x07", y: "0x00", health: 200, type: WALL }, { id: "0x13", x: "0x07", y: "0x01", health: 200, type: WALL },
            //     { id: "0x14", x: "0x07", y: "0x02", health: 200, type: WALL }, { id: "0x15", x: "0x07", y: "0x03", health: 200, type: WALL },
            //     { id: "0x16", x: "0x07", y: "0x04", health: 200, type: WALL }, { id: "0x17", x: "0x07", y: "0x05", health: 200, type: WALL },
            //     { id: "0x18", x: "0x06", y: "0x08", health: 255, type: WATER }, { id: "0x19", x: "0x07", y: "0x08", health: 255, type: WATER },
            //     { id: "0x20", x: "0x05", y: "0x09", health: 255, type: WATER }, { id: "0x21", x: "0x06", y: "0x09", health: 255, type: WATER },
            //     { id: "0x22", x: "0x07", y: "0x09", health: 255, type: WATER }, { id: "0x23", x: "0x08", y: "0x09", health: 255, type: WATER },
            // ];
            ...
            //     { action_type: "0x03", actor_id: actor_id, target_x: "0x13", target_y: "0x04" }
            // ];
            ...
            //     enemy_events: enemy_events_parsed, // Parsed Event[] - Circuit needs correct type
            //     my_result_advance,
            ...
            // setProof(extracted);
            //  console.log("Proof generated successfully.", { duration, extracted });
